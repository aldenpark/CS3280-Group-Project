...
public class clsDataAccess
{
	...
	{
        sConnectionString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data source= " + Directory.GetCurrentDirectory() + "\\Billing.mdb";
	}
    ...
    /// <summary>
    /// This method takes an SQL statement that is a non query, executes it and returns the incremented id
    /// </summary>
    /// <param name="sSQL">The SQL statement to be executed.</param>
    /// <returns>Returns the number of rows affected by the SQL statement.</returns>
    public int InsertNonQuery(string sSQL)
    {
        try
        {
            //Number of rows affected
